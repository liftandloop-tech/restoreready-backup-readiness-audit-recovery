...
<div align="center">
  <img src="./public/logo.svg" alt="RestoreReady — PC backups — Recovery" width="64" height="64">
  <h1>RestoreReady — PC backups — Recovery</h1>
</div>

Планировщик резервного копирования с проверкой восстановления на отдельном каталоге.
...
- **Backup coverage matrix** — запланированный модуль; реализации нет.
- **Restore drill checklist** — запланированный модуль; реализации нет.
- **Destination capacity estimate** — запланированный модуль; реализации нет.
...
3. Опишите один контрольный сценарий для **Backup coverage matrix**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="RestoreReady — PC backups — Recovery — specification review workflow">
<br>
...
Зафиксируйте входные данные и ожидаемый результат для модуля 1. Запишите версию PC backups, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Restore drill checklist

Зафиксируйте входные данные и ожидаемый результат для модуля 2. Запишите версию PC backups, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Destination capacity estimate

Зафиксируйте входные данные и ожидаемый результат для модуля 3. Запишите версию PC backups, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Кратко

| Поле | Значение |
|---|---|
| Продукт или область | PC backups |
| Категория | Утилиты для ПК |
| Входные данные | Ручные записи или разрешенный пользователем локальный экспорт |
| Планируемый результат | Backup coverage matrix |
